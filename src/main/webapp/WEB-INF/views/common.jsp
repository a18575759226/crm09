...
<script type="text/javascript" src="/static/js/jquery-easyui/highcharts.js"></script>
<script type="text/javascript" src="/static/js/jquery-easyui/highcharts-3d.js"></script>
<script type="text/javascript" src="/static/js/jquery-easyui/jquery.portal.js"></script>
